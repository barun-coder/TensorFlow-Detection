...
input_video = "./input_images_and_videos/indore_live _TI_2.mp4"
...
custom_object_counting_api.cumulative_object_custom_counting_y_axis(input_video, detection_graph, category_index, is_color_recognition_enabled, fps, width, height, roi, deviation) # counting all the objects
